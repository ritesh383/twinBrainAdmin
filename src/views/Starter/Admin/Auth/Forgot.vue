        ...
        <div class="col-lg-5 col-md-7">
          <div class="card card-profile bg-secondary mt-5">
            ...
            <div class="card-body pt-7 px-5">
              ...
              <form role="form">
                <base-input alternative prepend-icon="ni ni-lock-circle-open" type="password" placeholder="Password" v-model="model.password"></base-input>
                <div class="text-center">
                  <base-button type="primary" class="mt-2">Forgot</base-button>
                </div>
              </form>
            </div>
          </div>
